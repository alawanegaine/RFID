...
<<<<<<< Updated upstream:Code Source/PartieServeur/src/Template/Pages/home.ctp
                    <li><?php $this->element('accueil'); ?></li>
=======
                    <li><?php echo $this->Form->postLink(__('toto'), ['action' => 'acceuil'] ) ?></li>
                    <li> coucoue </li>
>>>>>>> Stashed changes:Code Source/PartieServeur/webroot/js/home.ctp
                </ul>
            </div>
        </div>
    </div>-->
